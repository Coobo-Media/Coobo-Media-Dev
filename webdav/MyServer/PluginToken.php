 ...
 */
class PluginToken extends DAV\ServerPlugin {
     ...
     * @param string $realm
     */
    public function __construct(Backend\BackendInterfaceToken $authBackend, $realm, $token) {
    ...
    public function beforeMethod($method, $uri) {
        ...
        $this->authBackend->authenticate($this->server,$this->realm,$this->token);
